...
ggplot(data = edu_score_suicide, mapping = aes(x = Education_Level, 
                                               y = Death_Rate)) + 
  geom_point() +
  geom_smooth(method = "lm") +
  labs(x = "Education Level Score",
       Y = "Suicide Death Rate (%)",
       title = "Education Level Score and Suicide Death Rate of 50 States in the US in 2017")
```
